...
<?php
    ...
    $para = "ramonrodriguesnw@gmail.com";
    ...
    $headers .= "From:  ramonrodriguesnw@gmail.com<ramonrodriguesnw@gmail.com>\n";
    //Vai ser //mostrado que  o email partiu deste email e seguido do nome
    $headers .= "X-Sender:  <ramonrodriguesnw@gmail.com>\n";
    //email do servidor //que enviou
    $headers .= "X-Mailer: PHP  v".phpversion()."\n";
    $headers .= "X-IP:  ".$_SERVER['REMOTE_ADDR']."\n";
    $headers .= "Return-Path:  <ramonrodriguesnw@gmail.com>\n";
